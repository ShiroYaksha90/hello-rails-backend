...
## Link to react forntend
https://github.com/ShiroYaksha90/hello-react-frontend

**hello-rails-backend** provide api to display random greetings.
...
```sh
  cd my-folder
  git clone https://github.com/ShiroYaksha90/hello-rails-backend.git
```
...
Feel free to check the [issues page](https://github.com/ShiroYaksha90/hello-rails-backend/issues).
